...
public class Config {
  ...
  private static ImagePipelineConfig configureCaches(Context context) {
    ...
    final MemoryCacheParams bitmapCacheParams = new MemoryCacheParams(
        Config.MAX_MEMORY_CACHE_SIZE, // 内存缓存中总图片的最大大小,以字节为单位。
        Integer.MAX_VALUE,                     // 内存缓存中图片的最大数量。
        Config.MAX_MEMORY_CACHE_SIZE, // 内存缓存中准备清除但尚未被删除的总图片的最大大小,以字节为单位。
    ...
    DiskCacheConfig diskSmallCacheConfig =  DiskCacheConfig.newBuilder(context)
        ...
        .setMaxCacheSize(Config.MAX_DISK_CACHE_SIZE)//默认缓存的最大大小。
  ...
  public static GenericDraweeHierarchy getGenericDraweeHierarchy(Context context){
    GenericDraweeHierarchy gdh = new GenericDraweeHierarchyBuilder(context.getResources())
        ...
        .setFailureImage(Config.sErrorDrawable)//fresco:failureImage="@drawable/error"失败图
        ...
        .setPlaceholderImage(Config.sPlaceholderDrawable)//fresco:placeholderImage="@color/wait_color"占位图
